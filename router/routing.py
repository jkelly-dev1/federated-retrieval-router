...
class HeuristicRouter:
    ...
    GRAPH whether the query links to a real node. That is a deliberate coupling
    -- the alternative is a hardcoded entity list in this file, which would be
    a second copy of the graph that silently drifts from the first.
    """
