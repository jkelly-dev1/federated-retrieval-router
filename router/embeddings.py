...
# 256 is carried over from the sibling ai-data-boundary-proxy, where a
# dimension sweep showed 64 manufactures similarity through hash collisions and
# 256 is the smallest width where unrelated texts stop colliding on this corpus
# size. tests/test_embeddings.py re-derives it here rather than trusting it.
DIMENSIONS = 256
...
# supposed to be best at -- and it is why tests/test_embeddings.py pins
# punctuation handling rather than assuming it.
