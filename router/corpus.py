...
This corpus is built backwards from the measurement, which is the only way it
...
# -------------------------------------------------------------------- graph
#
# The answer to a relationship question appears in no Document. That is what
# the graph leg is for, and the reason these edges are data rather than prose.
# "Which team owns a service that checkout depends on" requires two hops and is
# stated nowhere.
