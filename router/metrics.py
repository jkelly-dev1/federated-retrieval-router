...
good score on the easy majority hide a total failure on the interesting part.
"""
...
class CompetenceCheck:
    ...
    backend failing at its own competence, and it is worth reporting as that
    rather than quietly relabeling until the two agree.
    """
...
def validate_competences(
    ...
    scored zero. See RetrievalScore for why that distinction is load-bearing.
    """
